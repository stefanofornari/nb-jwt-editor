...
public class JwtDecoderServiceTest {
    ...
    @Test
    @DisplayName("decode_valid_jwt_token")
    public void decode_valid_jwt_token() {
    ...
    @Test
    @DisplayName("return_error_for_malformed_token")
    public void return_error_for_malformed_token() {
    ...
    @Test
    @DisplayName("return_error_for_invalid_base64")
    public void return_error_for_invalid_base64() {
        JwtDecoderService.DecodeResult result = service.decode("!!!.!!!.!!!");
    ...
    @Test
    @DisplayName("format_exp_field_with_timestamp_and_datetime")
    public void format_exp_field_with_timestamp_and_datetime() {
    ...
    @Test
    @DisplayName("extract_header_correctly")
    public void extract_header_correctly() {
    ...
    @Test
    @DisplayName("null_token_is_handled_gracefully")
    public void null_token_is_handled_gracefully() {
