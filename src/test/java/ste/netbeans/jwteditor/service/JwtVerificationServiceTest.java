...
public class JwtVerificationServiceTest {
    ...
    @Test
    @DisplayName("should_verify_valid_jwt_with_correct_secret")
    public void should_verify_valid_jwt_with_correct_secret() {
    ...
    @Test
    @DisplayName("should_reject_jwt_with_wrong_secret")
    public void should_reject_jwt_with_wrong_secret() {
    ...
    @Test
    @DisplayName("should_reject_secret_shorter_than_32_bytes")
    public void should_reject_secret_shorter_than_32_bytes() {
    ...
    @Test
    @DisplayName("should_accept_secret_with_32_or_more_bytes")
    public void should_accept_secret_with_32_or_more_bytes() {
    ...
    @Test
    @DisplayName("should_return_error_for_empty_secret")
    public void should_return_error_for_empty_secret() {
